				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped with-check"
							...
							<thead>
								<tr>
									<th style="width:700px;">主题类型名称</th>
									<th style="width:100px;">操作</th>
								</tr>
							</thead>
							<tbody>
								<!--~~~~~~~~~~~~~~~~~ 主题添加 ~~~~~~~~~~~~~~~~~-->
								<s:form action="typeAction_add" method="post">
									<tr class="TableDetail1 template">
										<td><s:textfield cssClass="form-control" name="name"></s:textfield>
										</td>
										<td><button type="submit" class="btn btn-success">添加</button>
										</td>
									</tr>
								</s:form>
