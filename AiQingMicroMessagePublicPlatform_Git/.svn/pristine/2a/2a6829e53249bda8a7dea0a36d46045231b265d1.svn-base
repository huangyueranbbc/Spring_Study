...
<!-- saved from url=(0041)http://www.390seo.com/404/demo/51/404.htm -->
...
<body>
	...
	<div class="yelangsembg">
		...
		<div class="wrap" style="margin-top:85px;">
			<div class="w7">
				<span><img src="images/404.gif"> </span> <span>
					<h1 style="">抱歉，您请求的页面出现异常，请稍后再次访问。</h1>
					<h2>您可以：</h2> <s:a action="homeAction_index" class="return">点击返回首页</s:a>
					<h3>
						本页面将在<em id="timeout">2</em>秒钟后自动转登录页面，请稍后...
					</h3> </span>
			</div>
		</div>
			...
			(function() {
				...
				var handler = function(i) {
					...
					if (i < 10) {
						...
						document.location = "homeAction_index";
					}
				};
...
<style type="text/css" id="15438256000"></style>
</html>
